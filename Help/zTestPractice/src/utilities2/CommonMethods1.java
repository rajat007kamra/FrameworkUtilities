...
//			Thread.sleep(2000);
	...
	public static void searchPage(String pageName, String time, String message) throws InterruptedException
	{
		try
		{
			...
			WriteTestResult.addRowInDetailsSheet(pageName +" SCREEN", "ENTER SCREEN", pageName, CommonMethods1.GetCurrentTimeStamp(), CommonValues.environmentName, CommonValues.tenantName, CommonValues.subTenantName, ReadLoginDetails.user_name1(), "", time, message);
		}
		catch(Exception ex)
		{
	...
	public static void searchPageNew(String pageName, String moduleName, String responsetime, String message) throws InterruptedException
	{
		try
		{
			...
			WriteTestResult.addRowInDetailsSheet(pageName +" SCREEN", "ENTER SCREEN", pageName, CommonMethods1.GetCurrentTimeStamp(), CommonValues.environmentName, CommonValues.tenantName, CommonValues.subTenantName, ReadLoginDetails.user_name1(), "", responsetime, message);
		}
		catch(Exception ex)
		{
			CreateLogs.writeLogs(ex.getMessage());
	...
	public static void verifyIsPageExists(String searchPath, String nameOfPage, String nameOfModule) throws Exception
	{
		...
		else
		{
			...
			WriteTestResult.addRowInDetailsSheet("VERIFY "+nameOfPage, nameOfPage +" SCREEN OPEN", nameOfPage, CommonMethods1.GetCurrentTimeStamp(), CommonValues.environmentName, CommonValues.tenantName, CommonValues.subTenantName, ReadLoginDetails.user_name1(), "", "", DeclareVariables.failResultMessage);
		}
	}
	...
	public static void clickIntranet() throws InterruptedException
	{
		...
		if(FunctionLibraries1.isElementPresent(By.xpath(intranetMenuXPath1)))
		{
			WebElement intranetMenu = DeclareVariables.wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(intranetMenuXPath1)));
			intranetMenu.click();
			CreateLogs.writeLogs("SYSTEM CLICKED ON INTRANET MENU SUCCESSFULLY");
			
//			Thread.sleep(2000);
			WebElement closeDashboard = FunctionLibraries1.locator("xpath", "/html/body/div[2]/div/div[1]/div/div[1]/div/div/div/div[2]");
		...
		else if(FunctionLibraries1.isElementPresent(By.xpath(intranetMenuXPath2)))
		{
			WebElement intranetMenu = DeclareVariables.wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(intranetMenuXPath2)));
			intranetMenu.click();
			CreateLogs.writeLogs("System clicked on INTRANET Menu successfully");
		}
		else
...
//        	System.out.println("FINAL TIME ::- " +DeclareVariables.timeTaken);
        	WriteTestResult.addRowInDetailsSheet("SAVE FEED", "SAVE FEED", "FEEDS", CommonMethods1.GetCurrentTimeStamp(), CommonValues.environmentName, CommonValues.tenantName, CommonValues.subTenantName, ReadLoginDetails.user_name1(), "", DeclareVariables.timeTaken, DeclareVariables.passResultMessage);
