	...
	public static void verifyLogin(String displayResult, String username, String password) throws Exception
	{
		try 
		{
			...
			if(submitBtn!= null)
			{
				...
				Thread.sleep(2000);
				FunctionLibraries1.locator("xpath", subTanentXPath).sendKeys("SE2");
				CreateLogs.writeLogs("SELECTED SUB TANENT IS ::- SE2");
				Thread.sleep(2000);
				...
				Thread.sleep(5000);
//				if(CommonMethods1.verifyHomePage().trim().equals("SE2"))
//				{
...
//						
//						double[] nums = {Login2.loginTime, Login3.loginTime};
//						Arrays.sort(nums);
//						
